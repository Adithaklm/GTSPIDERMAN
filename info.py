...
PICS = (environ.get('PICS', 'https://telegra.ph/file/5a4d6d2370cd69286166c.jpg')).split()
...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE","🎪 <b>Tɪᴛʟᴇ:  {title}\n\n📮  Iɴғᴏ : {runtime} | {release_date}</b>\n\n🎎 <b><i>Gᴇɴʀᴇ : {genres}\n🌟 Rᴀᴛɪɴɢ : {rating}\n🗣 Lᴀɴɢᴜᴀɢᴇ : {languages}</i></b>\n\n <b> Sᴜᴘᴘᴏʀᴛ Bʏ <a href=https://t.me/film_housc>CɪɴᴇᴍᴀCᴏᴍᴘᴀɴʏ</a></b>")
