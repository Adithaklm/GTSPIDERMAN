...
async def advantage_spoll_choker(bot, query):
    ...
    if int(user) != 0 and query.from_user.id != int(user):
        return await query.answer("മോനെ ഇത് നിനക്ക് ഉള്ളത് അല്ല ʀᴇǫᴜᴇsᴛ ʏᴏᴜʀ ᴏᴡɴ", show_alert=True)
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='rexienext'),
            InlineKeyboardButton('sᴛᴀᴛᴜs', callback_data='stats'),
            InlineKeyboardButton('ʜᴏᴍᴇ', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
            InlineKeyboardButton('✖️ 𝖡𝖺𝖼𝗄', callback_data='auto_manual'),
        ...
        buttons = [[
            InlineKeyboardButton('✖️ 𝖡𝖺𝖼𝗄', callback_data='manualfilter')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
...
InlineKeyboardButton('🔖 𝖬𝖺𝗇𝗎𝖺𝗅 𝖥𝗂𝗅𝗍𝖾𝗋', callback_data='manualfilter')

],[
            InlineKeyboardButton('🏡 𝖧𝗈𝗆𝖾', callback_data='help'),
...
async def advantage_spell_chok(msg):
    ...
    k=await query.message.reply_photo(photo="https://telegra.ph/file/4db5865a30975652f9fa1.jpg", caption=script.CHK_MOV, reply_markup=InlineKeyboardMarkup(btn))
    await asyncio.sleep(8)
    await k.delete()
