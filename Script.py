...
• /dkick - to kick deleted accounts."""
    ...
    STATUS = """{}\nChat Member Status**\n\n```recently``` - {}\n```within_week``` - {}\n```within_month``` - {}\n```long_time_ago``` - {}\nDeleted Account - {}\nBot - {}\nUnCached - {}
"""
    REQ_MOV = """നിങ്ങൾ ആവശ്യപ്പെട്ട മൂവി എനിക്ക് എന്റെ ഡാറ്റാബേസിൽ നിന്നും കണ്ടെത്താൻ കഴിഞ്ഞില്ല ഈ മൂവി ഗ്രൂപ്പിൽ ആഡ് ചെയ്യാൻ വേണ്ടി മുകളിൽ കാണിച്ചതുപോലെ അഡ്മിൻ  മെൻഷൻ ചെയ്യുക

I Cᴀɴ'ᴛ Fɪɴᴅ Yᴏᴜʀ Rᴇǫᴜᴇsᴛᴇᴅ Mᴏᴠɪᴇ Iɴ Mʏ Dᴀᴛᴀʙᴀsᴇ . Pʟᴇᴀsᴇ Mᴇɴᴛɪᴏɴ Tʜᴀᴛ Mᴏᴠɪᴇ Nᴀᴍᴇ Tᴏ Gʀᴏᴜᴘ Aᴅᴍɪɴ"""
